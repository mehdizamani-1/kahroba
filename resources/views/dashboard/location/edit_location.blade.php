                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form method="POST" enctype="multipart/form-data" action="/locations/{{ $location->id }}" class="step-form-horizontal jvalidate" id="step-form-horizontal" novalidate>
                                                @csrf
                                                @method('PUT')
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="container-fluid p-1">
                                                                                <div class="row ">
                                                                                    ...
                                                                                    <div class="col-12">
                                                                                        <input type="hidden" id="lat" value="{{ $location['lat'] }}" name="lat">
                                                                                        <input type="hidden" id="lng" value="{{ $location['lng'] }}" name="lng">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="formGroup col-4 p-1 mt-2">
                                                                                <input required type="text" id="1" class="formField" placeholder=" " name="title"
                                                                                       value="{{ old('title')?old('title'):$location['title'] }}">
                                                                            ...
                                                                            <div class="formGroup col-4 p-1 mt-2">
                                                                                <input autocomplete="off" type="text" id="3" class="formField" placeholder=" " name="street_view"
                                                                                       value="{{ old('street_view')?old('street_view'):$location['street_view'] }}">
                                                                            ...
                                                                            <div class="formGroup col-4 p-1 mt-2">
                                                                                <input autocomplete="off" type="text" id="3" class="formField" placeholder=" " name="virtual_tour"
                                                                                       value="{{ old('virtual_tour')?old('virtual_tour'):$location['virtual_tour'] }}">
                                                                            ...
                                                                            <div class="formGroup col-6 p-1 mt-2">
                                                                                <input required type="text" id="lat-input" class="formField" placeholder=" " name="lat"
                                                                                       value="{{ old('lat')?old('lat'):$location['lat'] }}" >
                                                                            ...
                                                                            <div class="formGroup col-6 p-1 mt-2">
                                                                                <input required type="text" id="lng-input" class="formField" placeholder=" " name="lng"
                                                                                       value="{{ old('lng')?old('lng'):$location['lng'] }}" >
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="formGroup col-12 p-1 mt-2">
                                                                                <input type="text" id="first_initial_brightness" class="formField" placeholder=" " name="abstract"
                                                                                       value="{{ old('abstract')?old('abstract'):$location['abstract'] }}">
                                                                                <label for="first_initial_brightness" class="formLabel">توضیحات مختصر</label>
                                                                            </div>
                                                                            <br>

                                                                            <div class="formGroup col-12 p-1 mt-2">
                                                                                <textarea id="summernote" class="formField" placeholder=" " name="description">{{ old('description')?old('description'):$location['description'] }}</textarea>
