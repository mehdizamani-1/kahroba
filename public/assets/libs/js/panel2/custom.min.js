...
(function($) {
    ...
    $(".nav-control").on('click', function() {
        ...
        $('#wrapperOne').toggleClass("menu-toggle");
	...
	for (var nk = window.location,
		...
		o = o.parent()
			...
			.parent()
			.addClass("mm-active");
		console.log('//to keep the current page active2') ;
	}
	...
	if(screenWidth <= 991 ){
		...
		jQuery('.close-fixed-content').on('click',function(){
			...
			jQuery('#wrapperOne').removeClass('menu-toggle');
			jQuery('.hamburger').show();
		});
	}
